...
public class MainClass {
	public static void main(String args[]) throws SQLException{
		...
		String createQuery= "Create table Trupti("+
							"emp_id integer not null,"+
							"name varchar(30));";
		String insertQuery= "insert into Trupti values"+
							"(1,'tru');";
		String deleteQuery= "Delete from Trupti where emp_id = 1";
		String dropTable = 	"drop table Trupti";
